 ...
 */
public class DominationPlaceholderExpansion extends PlaceholderExpansion {
     ...
     */
    public DominationPlaceholderExpansion(Domination plugin){
        this.plugin = plugin;
    }
    ...
    public String onPlaceholderRequest(Player player, String identifier){
        ...
        try {
            ...
            switch (identifier) {
                ...
                case "red_score":
                    return "" + plugin.getDominationGame().getScoreManager().getRedScore();
                case "blue_score":
                    return "" + plugin.getDominationGame().getScoreManager().getBlueScore();
    ...
    private String getPlayerScoreValue(int rankIndex, String stat){
        ...
        try {
            PlayerScore score = plugin.getDominationGame().getScoreManager().getScoreAtRank(rankIndex);
            Player player = plugin.getServer().getPlayer(score.getPlayerName());
            DyeColor team = plugin.getDominationGame().getTeamManager().getCurrentTeam(player).getColor();
        ...
        try {
            ...
            switch(stat) {
                ...
                case "defends":
                    ...
                    break;
                case "place":
                    value = ""+plugin.getDominationGame().getScoreManager().getCurrentRanking(player);
                    break;
                default:
                    break;
            }
